...
class _$CounterStateImpl implements _CounterState {
  const _$CounterStateImpl({this.counter = 0, this.milliseconds = 0});
  ...
  @override
  String toString() {
    return 'CounterState(counter: $counter, milliseconds: $milliseconds)';
  }
...
abstract class _CounterState implements CounterState {
  const factory _CounterState({final int counter, final int milliseconds}) =
      _$CounterStateImpl;
