...
# Test directory
# directories = ['counter_mobx', 'counter_mobx']
...
with open("simple_counter_benchmark_results.txt", "w") as output_file:
...
print("All directories have been processed. Results saved to simple_counter_benchmark_results.txt")
