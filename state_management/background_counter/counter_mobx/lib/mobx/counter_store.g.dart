...
mixin _$CounterStore on _CounterStore, Store {
  ...
  late final _$isMilestoneReachedAtom =
      Atom(name: '_CounterStore.isMilestoneReached', context: context);

  @override
  bool get isMilestoneReached {
    _$isMilestoneReachedAtom.reportRead();
    return super.isMilestoneReached;
  }

  @override
  set isMilestoneReached(bool value) {
    _$isMilestoneReachedAtom.reportWrite(value, super.isMilestoneReached, () {
      super.isMilestoneReached = value;
    });
  }
